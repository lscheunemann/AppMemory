...
$sqlUser = "Select nome_usuario_cliente, email_usuario_cliente, ativo from tb_usuarios_cliente where id_usuario_cliente = '$id'";
$resultadoUser = mysqli_query($conn, $sqlUser);
while ($linhaUser = mysqli_fetch_array($resultadoUser)) {
    $nome     = $linhaUser["nome_usuario_cliente"];
    $email    = $linhaUser["email_usuario_cliente"];
    $status   = $linhaUser["ativo"];
}
            ...
            <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6 text-center">
                        <h2>Gerenciar usuário de cliente</h2>
                    </div>
                </div>
            </div>
        </div><!-- End Page Header -->
                    ...
                    <div class="col-lg-9">
                        <form action="save-new-customer-user.php" method="post" role="form" class="php-email-form">
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="nome do cliente" value="<?php echo ($nome) ?>" readonly>

                                <div class="form-group mt-3">
                                    <label for="email">E-mail</label>
                                    <input type="text" class="form-control" name="email" id="email" placeholder="e-mail do cliente" value="<?php echo ($email) ?>" readonly>
                                </div>
                            ...
                            <div class="text-center d-flex justify-content-center gap-2">
                                ...
                                <?php if ($status == 1) {
                                    ...
                                    echo "<button class='btn btn-success mx-2' type='button' data-bs-toggle='modal' data-bs-target='#enableModal'>Ativar usuário</button>";
                                }; ?>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <h6>
                        <font color="black">Tem certeza que deseja desativar o usuário?</font>
                    </h6>
                </div>
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Não</button>
                    <a href="disable-user.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-success">Sim</button></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="enableModal" tabindex="-1" aria-labelledby="enableModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <h6>
                        <font color="black">Tem certeza que deseja ativar o usuário?</font>
                    </h6>
                </div>
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Não</button>
                    <a href="enable-user.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-success">Sim</button></a>
                </div>
            </div>
        </div>
    </div>
