...
<head>
    ...
    //obtém os dados do depoimento a ser aprovado
    $id = $_GET['id'];
    
    //aprova o depoimento na base de dados
    $sqlApprove = "UPDATE tb_depoimentos_ente SET aprovado=1 WHERE id_depoimento='$id'";
